...
<html>
<head>
    <title>Ambruz | Photographs</title>
...
<body>
    ...
    <div class="banner">
        <table cellspacing="0" width="100%">
            <tr bgcolor="#FBEDE9">
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>
                    <h1><font color="#3E598E">Discover the top Creators & Designers</font></h1><h3><font color="#E35C5A">Ambruz is the leading destination to find & showcase creative work and <br/>home to the best design professionals.</font><br/><font color="black">Sign Up now</font><br/><a href="register.php" class="signupButton">Sign Up</a></h3>
                </td>
    ...
    <div class="shots_Gallery">
        <section class="gallery-links-shots">
            <div class="wrapper">
                <h2>Trending Shots</h2>

                <div class="gallery-container-shots">
                    <?php 
                    include_once 'upload/dbh.inc.php';

                    $sql = "SELECT * FROM gallery WHERE Type='A Photograph' ORDER BY OrderGallery DESC";
